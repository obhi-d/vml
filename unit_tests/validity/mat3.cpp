...
{
  vml::mat4_t m2 = {3.0f, 10.0f, 12.0f, 18.0f, 12.0f, 1.0f, 4.0f, 9.0f, 9.0f, 10.0f, 12.0f, 2.0f, 0, 0, 0, 0};

  vml::mat4_t m2_times_3 = {9.0f,  30.0f, 36.0f, 54.0f, 36.0f, 3.0f, 12.0f, 27.0f,
