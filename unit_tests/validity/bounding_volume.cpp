...
{
  vml::bounds_info_t bounds = {{-2.0f, -2.0f, -2.0f}, {2.0f, 2.0f, 2.0f}, -1.0f};

  vml::bounds_info_t bounds1 = {{-2.0f, -2.0f, -2.0f}, {2.0f, 2.0f, 2.0f}, 3.4641f};
  vml::bounds_info_t bounds2 = {{2.0f, 2.0f, 2.0f}, {2.0f, 2.0f, 2.0f}, 3.4641f};
...
{
  vml::bounding_volume_t bounds1 =
    vml::bounding_volume::from_box(vml::vec3a::set(2.0f, 1.0f, 5.0f), vml::vec3a::set(4.0f, 1.0f, 6.0f));
...
TEST_CASE("Validate bounding_volume::set", "[bounding_volume::set]")
{
  ...
  bounds1 =
    vml::bounding_volume::set(vml::sphere::set(12.0f, 31.0f, 5.0f, 22.0f), vml::vec3a::set(14.0f, 15.0f, 61.0f));
...
TEST_CASE("Validate bounding_volume::update(matrix)", "[bounding_volume::update(matrix)]")
{
  ...
  vml::mat4_t m = vml::mat4::from_scale_rotation_translation(
    2.0f, vml::quat::from_axis_angle(vml::vec3::set(0.0f, 1.0f, 0.0f), vml::to_radians(45.0f)),
...
TEST_CASE("Validate bounding_volume::update(srt)", "[bounding_volume::update(srt)]")
{
  ...
  vml::bounding_volume::update(bounds1, 2.0f,
                               vml::quat::from_axis_angle(vml::vec3::set(0.0f, 1.0f, 0.0f), vml::to_radians(45.0f)),
                               vml::vec3a::set(2.0f, 0.0f, 0.0f));
...
TEST_CASE("Validate bounding_volume::update(points)", "[bounding_volume::update(points)]")
{
  ...
  vml::vec3a_t points[3] = {vml::vec3a::set(-5.0f, -4.0f, 5.0f), vml::vec3a::set(-15.0f, -14.0f, -5.0f),
